...
const SEED_STEPS: ResumptionStep[] = [
  ...
  { id: 16, planId: 2, stepType: 'hazard-check', stepOrder: 5, status: 'done', completedBy: '赵班长', completedAt: '2026-02-04 09:00:00', remark: '排查隐患 3 项，已完成整改', attachments: [], formData: { foundAt: '2026-02-04', foundBy: '赵班长', hazards: [{ id: 1, description: '喷涂车间2号排风管道滤网积尘严重', level: 'general', photos: [], status: 'rectified', foundAt: '2026-02-04', foundBy: '赵班长', rectificationMeasure: '清洗滤网并更换密封垫', rectificationBy: '钱小华', rectificationAt: '2026-02-04' }, { id: 2, description: '喷涂机械臂急停按钮标识脱落', level: 'general', photos: [], status: 'accepted', foundAt: '2026-02-04', foundBy: '钱小华', rectificationMeasure: '更换急停按钮标识贴纸', rectificationBy: '钱小华', rectificationAt: '2026-02-04', acceptanceConclusion: '标识清晰，验收通过', acceptanceBy: '王安全', acceptanceAt: '2026-02-04' }, { id: 3, description: '喷漆房可燃气体探测器未年检', level: 'major', photos: [], status: 'archived', foundAt: '2026-02-04', foundBy: '赵班长', disposalMeasure: '联系第三方检测机构安排年检', disposalBy: '王安全', disposalAt: '2026-02-04', rectificationMeasure: '完成年检并出具合格报告', rectificationBy: '王安全', rectificationAt: '2026-02-04', acceptanceConclusion: '年检合格，证书已归档', acceptanceBy: '陈建国', acceptanceAt: '2026-02-04', archivedAt: '2026-02-04' }] } },
  { id: 17, planId: 2, stepType: 'device-check', stepOrder: 6, status: 'done', completedBy: '赵班长', completedAt: '2026-02-04 11:00:00', remark: '喷涂线 6 台设备逐台空载试运行，2 台需维修→已处理', attachments: [], formData: { devices: [{ id: 1, deviceName: '高压无气喷涂机', location: '喷涂车间A区', checker: '赵班长', checkTime: '2026-02-04', result: 'normal', checkItems: [{ label: '电源线路', checked: true }, { label: '压力表', checked: true }, { label: '喷嘴', checked: true }, { label: '安全阀', checked: true }], handling: '', photos: [] }, { id: 2, deviceName: '自动静电喷涂线', location: '喷涂车间B区', checker: '赵班长', checkTime: '2026-02-04', result: 'needs_repair', checkItems: [{ label: '电源线路', checked: true }, { label: '静电发生器', checked: false }, { label: '输送链', checked: true }, { label: '回收系统', checked: true }], handling: '静电发生器输出电压不稳定，需更换高压模块', photos: [] }, { id: 3, deviceName: '烘干炉', location: '喷涂车间B区', checker: '钱小华', checkTime: '2026-02-04', result: 'needs_repair', checkItems: [{ label: '温控系统', checked: false }, { label: '燃烧器', checked: true }, { label: '风机', checked: true }, { label: '排烟管道', checked: true }], handling: '温控探头偏差超标，需校准更换', photos: [] }, { id: 4, deviceName: '水帘喷漆柜', location: '喷涂车间A区', checker: '钱小华', checkTime: '2026-02-04', result: 'normal', checkItems: [{ label: '水循环系统', checked: true }, { label: '排风系统', checked: true }, { label: '过滤网', checked: true }, { label: '照明', checked: true }], handling: '', photos: [] }, { id: 5, deviceName: '打磨除尘一体机', location: '喷涂车间C区', checker: '赵班长', checkTime: '2026-02-04', result: 'normal', checkItems: [{ label: '电机运转', checked: true }, { label: '滤筒', checked: true }, { label: '清灰装置', checked: true }, { label: '防爆装置', checked: true }], handling: '', photos: [] }, { id: 6, deviceName: '空压机', location: '喷涂车间机房', checker: '钱小华', checkTime: '2026-02-04', result: 'normal', checkItems: [{ label: '油位', checked: true }, { label: '压力开关', checked: true }, { label: '安全阀', checked: true }, { label: '排水阀', checked: true }], handling: '', photos: [] }] } },
  ...
  { id: 27, planId: 3, stepType: 'hazard-check', stepOrder: 5, status: 'done', completedBy: '马班长', completedAt: '2026-01-16 14:00:00', remark: '排查 5 项隐患', attachments: [], formData: { foundAt: '2026-01-16', foundBy: '马班长', hazards: [{ id: 10, description: '组装线传送带防护罩缺失', level: 'major', photos: [], status: 'archived', foundAt: '2026-01-16', foundBy: '马班长', disposalMeasure: '立即停机设置临时警戒', disposalBy: '马班长', disposalAt: '2026-01-16', rectificationMeasure: '安装新防护罩并测试联锁装置', rectificationBy: '周小军', rectificationAt: '2026-01-16', acceptanceConclusion: '防护罩安装牢固，联锁正常', acceptanceBy: '孙安全', acceptanceAt: '2026-01-17', archivedAt: '2026-01-17' }, { id: 11, description: '包装区地面油渍未清理', level: 'general', photos: [], status: 'archived', foundAt: '2026-01-16', foundBy: '周小军', rectificationMeasure: '清洗地面并铺设防滑垫', rectificationBy: '周小军', rectificationAt: '2026-01-16', acceptanceConclusion: '已清理，防滑垫铺设到位', acceptanceBy: '孙安全', acceptanceAt: '2026-01-16', archivedAt: '2026-01-16' }, { id: 12, description: '电动螺丝刀电源线破损露铜', level: 'general', photos: [], status: 'archived', foundAt: '2026-01-16', foundBy: '马班长', rectificationMeasure: '更换整根电源线', rectificationBy: '周小军', rectificationAt: '2026-01-16', acceptanceConclusion: '更换完成，绝缘测试通过', acceptanceBy: '孙安全', acceptanceAt: '2026-01-16', archivedAt: '2026-01-16' }, { id: 13, description: '消防通道堆放包装箱', level: 'general', photos: [], status: 'archived', foundAt: '2026-01-16', foundBy: '周小军', rectificationMeasure: '清理通道并张贴禁堆标识', rectificationBy: '周小军', rectificationAt: '2026-01-16', acceptanceConclusion: '通道畅通，标识已张贴', acceptanceBy: '孙安全', acceptanceAt: '2026-01-16', archivedAt: '2026-01-16' }, { id: 14, description: '零件暂存区照明不足', level: 'general', photos: [], status: 'archived', foundAt: '2026-01-16', foundBy: '马班长', rectificationMeasure: '加装2盏LED工矿灯', rectificationBy: '周小军', rectificationAt: '2026-01-17', acceptanceConclusion: '照度达标，安装牢固', acceptanceBy: '孙安全', acceptanceAt: '2026-01-17', archivedAt: '2026-01-17' }] } },
  { id: 28, planId: 3, stepType: 'device-check', stepOrder: 6, status: 'done', completedBy: '马班长', completedAt: '2026-01-17 10:00:00', remark: '12 台设备逐台检查，3 台保养', attachments: [], formData: { devices: [{ id: 10, deviceName: '环形组装线', location: '组装车间主区', checker: '马班长', checkTime: '2026-01-17', result: 'normal', checkItems: [{ label: '传动链', checked: true }, { label: '工装板', checked: true }, { label: '阻挡器', checked: true }, { label: '急停按钮', checked: true }], handling: '', photos: [] }, { id: 11, deviceName: '自动螺丝机', location: '组装车间主区', checker: '马班长', checkTime: '2026-01-17', result: 'normal', checkItems: [{ label: '供料系统', checked: true }, { label: '扭力校准', checked: true }, { label: '定位夹具', checked: true }, { label: '安全光幕', checked: true }], handling: '', photos: [] }, { id: 12, deviceName: '气密性检测台', location: '组装车间检测区', checker: '周小军', checkTime: '2026-01-17', result: 'needs_repair', checkItems: [{ label: '压力传感器', checked: false }, { label: '密封夹具', checked: true }, { label: '充气阀', checked: true }, { label: '显示屏', checked: true }], handling: '压力传感器漂移，需返厂校准', photos: [] }, { id: 13, deviceName: '激光打标机', location: '组装车间主区', checker: '周小军', checkTime: '2026-01-17', result: 'normal', checkItems: [{ label: '激光功率', checked: true }, { label: '冷却系统', checked: true }, { label: '光路对准', checked: true }, { label: '急停', checked: true }], handling: '', photos: [] }, { id: 14, deviceName: 'AGV搬运车', location: '组装车间物流区', checker: '马班长', checkTime: '2026-01-17', result: 'normal', checkItems: [{ label: '电池', checked: true }, { label: '导航传感器', checked: true }, { label: '防撞条', checked: true }, { label: '举升机构', checked: true }], handling: '', photos: [] }] } },
  ...
  { id: 38, planId: 4, stepType: 'hazard-check', stepOrder: 5, status: 'done', completedBy: '何班长', completedAt: '2026-03-02 09:00:00', remark: '排查隐患2项', attachments: [], formData: { foundAt: '2026-03-02', foundBy: '何班长', hazards: [{ id: 20, description: '锅炉水位计玻璃管积垢影响读数', level: 'general', photos: [], status: 'rectified', foundAt: '2026-03-02', foundBy: '何班长', rectificationMeasure: '清洗水位计并更换密封垫圈', rectificationBy: '刘师傅', rectificationAt: '2026-03-02' }, { id: 21, description: '燃气管道法兰连接处微量泄漏', level: 'major', photos: [], status: 'disposed', foundAt: '2026-03-02', foundBy: '何班长', disposalMeasure: '紧固螺栓并用检漏仪复测，确认无泄漏', disposalBy: '何班长', disposalAt: '2026-03-02' }] } },
  { id: 39, planId: 4, stepType: 'device-check', stepOrder: 6, status: 'done', completedBy: '何班长', completedAt: '2026-03-02 11:00:00', remark: '锅炉本体及辅机检查，燃烧器需清洗', attachments: [], formData: { devices: [{ id: 20, deviceName: '燃气蒸汽锅炉', location: '锅炉房主机区', checker: '何班长', checkTime: '2026-03-02', result: 'normal', checkItems: [{ label: '水位控制系统', checked: true }, { label: '压力表/安全阀', checked: true }, { label: '燃烧器', checked: true }, { label: '炉膛耐火衬里', checked: true }], handling: '', photos: [] }, { id: 21, deviceName: '燃烧器', location: '锅炉房主机区', checker: '何班长', checkTime: '2026-03-02', result: 'needs_repair', checkItems: [{ label: '点火电极', checked: true }, { label: '火焰探测器', checked: true }, { label: '喷嘴', checked: false }, { label: '风门调节器', checked: true }], handling: '喷嘴积碳严重需清洗，火焰探测器灵敏度下降需更换', photos: [] }, { id: 22, deviceName: '软水处理装置', location: '锅炉房辅机区', checker: '刘师傅', checkTime: '2026-03-02', result: 'normal', checkItems: [{ label: '树脂罐', checked: true }, { label: '盐箱', checked: true }, { label: '控制器', checked: true }, { label: '管路阀门', checked: true }], handling: '', photos: [] }, { id: 23, deviceName: '分汽缸', location: '锅炉房辅机区', checker: '刘师傅', checkTime: '2026-03-02', result: 'normal', checkItems: [{ label: '保温层', checked: true }, { label: '疏水阀', checked: true }, { label: '压力表', checked: true }, { label: '排污阀', checked: true }], handling: '', photos: [] }] } },
