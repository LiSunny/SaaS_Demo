...
| 13 | 发起工单弹窗 | 浮层 | `FormDialog` | width=560px，步骤1 模板选择（2×2 卡片网格，单选蓝色高亮，显示模板名称+v版本+节点数）；步骤2 工单信息（priority radio-group: 紧急/高/普通/低 默认normal + description textarea maxlength=200） |
...
| priority | 优先级 | string | radio-group | 是 | — | urgent/紧急 high/高 normal/普通 low/低，默认 normal |
