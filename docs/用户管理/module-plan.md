...
> **文档版本**: v1.0
> **生成日期**: 2026-06-26
> **上游文档**: docs/用户管理/biz-design.md v1.5
> **平台参考**: 11 岗位 × 四方协同模型（docs/平台岗位设计.md）
...
| **岗位 (Position)** | 名称、key、所属企业(null=内置)、数据范围、权限集 | 平台内置岗 + 企业自定义岗，双层模型 |
| **企业自定义岗位 (EnterprisePosition)** | enterpriseId、name、key、dataScope、permissions | 企业管理员自建，仅本企业可用 |
...
- **职责**：企业管理员视角——添加用户到本企业、分配岗位、从企业移除
- **核心功能点**：
